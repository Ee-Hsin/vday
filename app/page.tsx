  ...
  return (
    <div className="h-screen relative bg-[#ffeded] overflow-hidden">
      ...
      <div className="relative z-10 mt-[5vh] md:mt-[80px] px-[5vw] md:px-0 md:ml-[100px] w-full md:w-auto text-center md:text-left">
        <h1 className={`text-[12vw] md:text-9xl font-bold mb-[0vh] text-[#d98f8f] ${fredoka.className}`}>
          Valentine&apos;s Day
        </h1>
        <h2 className={`text-[10vw] md:text-7xl font-bold mb-[3.5vh] text-[#d98f8f] leading-[0.9] md:leading-normal ${fredoka.className}`}>
          Personal Website Generator
        </h2>
        <p className={`text-[5vw] md:text-4xl max-w-5xl leading-relaxed text-[#aa9a7d] ${poppins.className}`}>
      ...
      <div className="mt-[7vh] md:static w-full px-[5vw] flex justify-center gap-[4vw] md:block">
        ...
        >
          <button className={`bg-[#d98f8f] text-white font-bold text-[5vw] whitespace-nowrap md:text-4xl py-[2vh] md:py-8 px-[4vw] md:px-[60px] rounded-full relative z-10 transition-shadow duration-200 ease-in-out group-hover:shadow-[0_0_20px_rgba(217,143,143,0.8)] ${fredoka.className}`}>
            Create Website
          </button>

          <div className="w-[30vw] h-[15vh] -mt-[16vh] md:w-[288px] md:h-[260px] md:-mt-[275px] relative z-20 left-1/2 -translate-x-1/2">
            <Image
              src={window.innerWidth >= 768 ? (isCreateHovered ? happy : sad) : happy}
              alt="Mood"
        ...
        >
          ...
          <div className="w-[30vw] h-[15vh] -mt-[16vh] md:w-[288px] md:h-[260px] md:-mt-[275px] relative z-20 left-1/2 -translate-x-1/2">
            <Image
              src={window.innerWidth >= 768 ? (isExampleHovered ? happy : sad) : happy}
              alt="Mood"
              className="w-full h-full object-contain"
              priority
            />
