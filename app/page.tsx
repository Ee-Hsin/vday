...
import LandingExampleButton from "@/components/LandingExampleButton"
  ...
  return (
    <div className="h-svh md:h-screen relative bg-[#ffeded] overflow-hidden">
      ...
      <div className="relative z-10 mt-[5svh] md:mt-[65px] px-[5vw] md:px-0 md:ml-[80px] w-full md:w-auto text-center md:text-left">
        <h1 className="text-[12vw] md:text-8xl font-bold mb-[0svh] text-[#d98f8f] font-fredoka">
          Valentine&apos;s Day
        </h1>
        <h2 className="text-[10vw] md:text-7xl font-bold mb-[3.5svh] text-[#d98f8f] leading-[0.9] md:leading-normal font-fredoka">
          Digital Card Generator
        </h2>
        <p className="text-[5vw] md:text-3xl max-w-3xl leading-relaxed text-[#aa9a7d] font-poppins">
